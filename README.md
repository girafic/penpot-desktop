...
- **Context-aware menus** that switch automatically between dashboard and workspace mode:
  - *Dashboard:* File (New Project), Edit, View, Go (Drafts, Libraries, Search)
  - *Workspace:* File (Export), Edit (Duplicate, Group, Components), View (Zoom, Rulers, Panels), Shape (Tools, Boolean ops, Alignment, Ordering), Go (Viewer, Inspect, Dashboard)
...
- **Keyboard shortcut bridge** — all native menu shortcuts are translated to synthetic keyboard events for Penpot's internal handler
